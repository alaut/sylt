...
Sylt (**SY**nchrotron **L**ongitudinal **T**racker) is a python package used to conveniently describe and analyse realistic longitudinal beam dynamics simulations in synchrotrons.
...
- A. Laut and A. Lasheen, “[Influence of Transverse Motion on Longitudinal Space Charge in the CERN PS](https://doi.org/10.18429/JACoW-HB2021-MOP13),” presented at the 64th ICFA Advanced Beam Dynamics Workshop, Fermilab, 2021.
